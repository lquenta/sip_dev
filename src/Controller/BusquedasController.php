    ...
    public function avanzada(){
         $resultados=array(
            'resultados'=>
                ...
                'grupo_poblacional'=>'Niñas,<strong> niños</strong> y adolescentes',
                'derechos'=>'Desarrrollo , Interés superior del<strong> niño</strong>/a, Participación',
                'institucion'=>'Estado',
                'observaciones_finales'=>'cerberus-test.com/upload/archivo1.pdf',
                'recomendacion'=>'(1)129. Se está revisando el Código<strong> Niño</strong>, Niña y Adolescentederecvio, incorporando la protección jurídica integral de los derechos de las niñas,<strong> niños</strong> y adolescentes, resaltando el interés superior del<strong> niño</strong>/a, el derecho a la familia, al desarrollo integral, la filiación sin  discriminación alguna y el derecho a la identidad. Además, sanciona y prohíbe toda forma de violencia, trabajo forzoso y explotación en contra de niñas,<strong> niños</strong> y adolescentes y armoniza procedimientos administrativos y judiciales para la adopción, con el fin de garantizarles una familia.',
                'acciones'=>array(
                    array( 'id_accion'=>'1',
                    'descripcion'=>'(1)129. Se está revisando el Código<strong> Niño</strong>, Niña y Adolescentederecvio, incorporando la protección jurídica integral de los derechos de las niñas,<strong> niños</strong> y adolescentes, resaltando el interés superior del<strong> niño</strong>/a, el derecho a la familia, al desarrollo integral, la filiación sin  discriminación alguna y el derecho a la identidad. Además, sanciona y prohíbe toda forma de violencia, trabajo forzoso y explotación en contra de niñas,<strong> niños</strong> y adolescentes y armoniza procedimientos administrativos y judiciales para la adopción, con el fin de garantizarles una familia.',
                    'fecha'=>'21-07-2014',
                ...
                'acciones'=>array(
                    ...
                    'fecha'=>'21-07-2014',
                    'indicadores'=>array(
                       'vivienda' =>array('Porcentaje de niños y niñas menores a 2 años beneficiarios del Bono Juana Azurduy.'),
                       'trataTrafico' =>array('Brecha salarial entre hombres y mujeres por categoría ocupacional')
                       ),
                ...
                array( 'id_accion'=>'4',
                    ...
                    'fecha'=>'21-07-2014',
                    'indicadores'=>array(
                       'educacion' =>array('Número de estudiantes de primaria que recibieron el bono Juancito Pinto'),
                       'alimentacion' =>array('Porcentaje de Mujeres GESTANTES beneficiarias del Bono Juana Azurduy.')
                       ),
