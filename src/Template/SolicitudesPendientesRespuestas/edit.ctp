...
?>
    ...
    $this->Form->postLink(
        __('Delete'),
        ['action' => 'delete', $solicitudesPendientesRespuesta->id],
        ['confirm' => __('Are you sure you want to delete # {0}?', $solicitudesPendientesRespuesta->id)]
    )
    ?>
    </li>
...
<fieldset>
    <legend><?= __('Edit {0}', ['Solicitudes Pendientes Respuesta']) ?></legend>
    <?php
