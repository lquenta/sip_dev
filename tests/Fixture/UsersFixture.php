...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre_usuario' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_usuarios_1_idx' => ['type' => 'index', 'columns' => ['rol_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_usuarios_1' => ['type' => 'foreign', 'columns' => ['rol_id'], 'references' => ['rols', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'fecha_creacion' => '2016-06-24 16:59:20',
            'fecha_modificacion' => '2016-06-24 16:59:20',
            'rol_id' => 1
        ],
    ];
}
